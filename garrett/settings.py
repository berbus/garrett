"""
Django settings for garrett project.
...
INSTALLED_APPS = [
    ...
    'django.contrib.sessions', 'django.contrib.messages', 'django.contrib.staticfiles', 'api',
    'rest_framework',
    'django_extensions'
]
...
WSGI_APPLICATION = 'garrett.wsgi.application'
